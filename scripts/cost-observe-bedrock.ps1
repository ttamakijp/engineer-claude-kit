...
# UTF-8 (no BOM) file I/O helper. The generated report is user-visible markdown,
# so write it without a BOM on every PowerShell version. See ADR-0003 section C.
